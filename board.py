...
class Board:
    ...
    def draw_board(self):
        ...
        # Crea la tortuga para dibujar la tortuga
        othello = turtle.Turtle(visible = False)
        othello.penup()
        othello.speed(0)
        othello.hideturtle()

        # establece el colo de las lineas y del tablero
    ...
    def draw_tile(self, square, color):
        ...
        # Crea la tortuga para dibujar las fichas 
        tile = turtle.Turtle(visible = False)
        tile.penup()
        tile.speed(0)
        tile.hideturtle()

        # Crea el color de las fichas
        tile.color(self.tile_colors[color])

        # Mueve la tortuga desde la pocision inicial 
